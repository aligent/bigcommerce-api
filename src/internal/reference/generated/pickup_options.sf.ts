...
export interface components {
    schemas: {
        readonly PickupRequestPayload: {
            readonly searchArea?: components["schemas"]["SearchArea"];
        ...
        readonly PickupOptionsResponse: {
            ...
            readonly pickupOptions?: readonly components["schemas"]["PickupOption"][];
        };
        readonly PickupOption: {
            readonly pickupMethod?: components["schemas"]["PickupMethod"];
            /** @description Items that are available using the pickup method. */
            readonly availableItems?: readonly components["schemas"]["AvailableItem"][];
        };
            ...
            readonly 200: {
                ...
                content: {
                    readonly "application/json": {
                        readonly results?: readonly components["schemas"]["PickupOptionsResponse"][];
                    };
                };
            };
        };
