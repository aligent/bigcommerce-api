...
export interface paths {
    readonly "/blog/tags": {
         ...
         */
        readonly get: operations["getBlogTags"];
    };
    readonly "/blog/posts": {
        readonly parameters: {
            readonly query?: never;
         ...
         */
        readonly get: operations["getBlogPosts"];
        /**
         * Create a Blog Post
         ...
         */
        readonly post: operations["createBlogPosts"];
        /**
         * Delete Blog Posts
         * @description Deletes a page of `Blog Posts`.
         */
        readonly delete: operations["deleteBlogPosts"];
    };
    readonly "/blog/posts/{id}": {
         ...
         */
        readonly get: operations["getBlogPost"];
        /**
         * Update a Blog Post
         ...
         *     * Blog posts default to draft status. To publish blog posts to the storefront, set the `is_published` property to `true`.
         */
        readonly put: operations["updateBlogPost"];
        /**
         * Delete a Blog Post
         * @description Deletes a *Blog Post*.
         */
        readonly delete: operations["deleteBlogPost"];
    };
    readonly "/blog/posts/count": {
         ...
         */
        readonly get: operations["getBlogPostsCount"];
    };
    readonly "/pages": {
        readonly parameters: {
            readonly query?: never;
         ...
         */
        readonly post: operations["createPage"];
    };
    readonly "/pages/{id}": {
        readonly parameters: {
            readonly query?: never;
    ...
    readonly "/redirects": {
         ...
         */
        readonly post: operations["createRedirect"];
        /**
    ...
    readonly "/redirects/{id}": {
         ...
         */
        readonly get: operations["getRedirect"];
        /**
         * Update a Redirect
         ...
         */
        readonly put: operations["updateRedirect"];
        /**
         * Delete a Redirect
         ...
         */
        readonly delete: operations["deleteRedirect"];
    };
    readonly "/redirects/count": {
         ...
         */
        readonly get: operations["getRedirectsCount"];
    };
}
...
export interface components {
    schemas: {
        ...
        readonly redirect: {
            ...
            readonly forward: components["schemas"]["forward"];
            /**
        ...
        readonly blogPost_Base: {
             ...
             */
            readonly is_published: boolean;
            readonly published_date?: components["schemas"]["publishedDate"];
            /**
...
export interface operations {
    readonly getBlogTags: {
        ...
        readonly responses: {
            readonly 200: {
                ...
                content: {
                    readonly "application/json": readonly components["schemas"]["blogTags"][];
                };
            };
        };
    };
    readonly getBlogPosts: {
        readonly parameters: {
            readonly query?: {
    ...
    readonly createBlogPosts: {
        ...
        readonly requestBody: {
            readonly content: {
                readonly "application/json": components["schemas"]["blogPost_Base_Post"];
            };
        };
        readonly responses: {
            readonly 200: {
