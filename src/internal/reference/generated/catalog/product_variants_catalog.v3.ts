...
export interface paths {
    readonly "/catalog/products/{product_id}/variants": {
         ...
         */
        readonly get: operations["getProductVariants"];
        /**
         ...
         */
        readonly post: operations["createProductVariant"];
    };
    readonly "/catalog/products/{product_id}/variants/{variant_id}": {
         ...
         */
        readonly get: operations["getProductVariant"];
        /**
         * Update a product variant
         * @description Updates a product variant.
         */
        readonly put: operations["updateProductVariant"];
        /**
         * Delete a product variant
         * @description Deletes a product variant.
         */
        readonly delete: operations["deleteProductVariant"];
    };
    readonly "/catalog/products/{product_id}/variants/{variant_id}/metafields": {
         ...
         */
        readonly get: operations["getProductVariantMetafields"];
        /**
         ...
         */
        readonly post: operations["createProductVariantMetafield"];
    };
    readonly "/catalog/products/{product_id}/variants/{variant_id}/metafields/{metafield_id}": {
         ...
         */
        readonly get: operations["getProductVariantMetafield"];
        /**
         ...
         */
        readonly put: operations["updateProductVariantMetafield"];
        /**
         * Delete a Product Variant Metafield
         * @description Deletes a product variant *Metafield*.
         */
        readonly delete: operations["deleteProductVariantMetafield"];
    };
    readonly "/catalog/products/{product_id}/variants/{variant_id}/image": {
         ...
         */
        readonly post: operations["createProductVariantImage"];
    };
    ...
    readonly "/catalog/variants/metafields": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description The [MIME type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) of the response body. */
         ...
         */
        readonly get: operations["getVariantsMetafields"];
        /**
         * Update multiple Metafields
         * @description Create multiple metafields.
         */
        readonly put: operations["updateVariantsMetafields"];
        /**
         * Create multiple Metafields
         * @description Create multiple metafields.
         */
        readonly post: operations["createVariantsMetafields"];
        /**
         * Delete multiple Metafields
         * @description Delete all variant metafields.
         */
        readonly delete: operations["deleteVariantsMetafields"];
    };
}
...
export interface components {
    schemas: {
         ...
         */
        readonly productVariant_Put: components["schemas"]["productVariant_Base"] & {
            readonly product_id?: number;
            readonly sku?: string;
        };
...
export interface operations {
    ...
    readonly createProductVariant: {
        ...
        readonly requestBody: {
            readonly content: {
                readonly "application/json": components["schemas"]["productVariant_Post"];
            };
        };
        readonly responses: {
            readonly 200: {
    ...
    readonly updateProductVariant: {
        ...
        readonly requestBody: {
            readonly content: {
                readonly "application/json": components["schemas"]["productVariant_Put"];
            };
        };
        readonly responses: {
            readonly 200: {
    ...
    readonly getProductVariantMetafields: {
        readonly parameters: {
            readonly query?: {
                /** @description Fields to include, in a comma-separated list. The ID and the specified fields will be returned. */
                readonly include_fields?: components["parameters"]["IncludeFieldsParam"];
            ...
            readonly 200: {
                ...
                content: {
                    readonly "application/json": {
                        ...
                        readonly meta?: components["schemas"]["categoriesTree_Resp"];
                    };
                };
            };
        };
    };
    readonly createProductVariantMetafield: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: {
                /** @description The [MIME type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) of the response body. */
    ...
    readonly getProductVariantMetafield: {
        readonly parameters: {
            readonly query?: {
                /** @description Fields to include, in a comma-separated list. The ID and the specified fields will be returned. */
                readonly include_fields?: components["parameters"]["IncludeFieldsParam"];
    ...
    readonly updateProductVariantMetafield: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: {
                /** @description The [MIME type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) of the response body. */
    ...
    readonly deleteProductVariantMetafield: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: {
                /** @description The [MIME type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) of the response body. */
    ...
    readonly createProductVariantImage: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: {
                /** @description The [MIME type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) of the response body. */
    ...
    readonly updateVariantsMetafields: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: {
                /** @description The [MIME type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) of the response body. */
    ...
    readonly createVariantsMetafields: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: {
                /** @description The [MIME type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) of the response body. */
    ...
    readonly deleteVariantsMetafields: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: {
                /** @description The [MIME type](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) of the response body. */
