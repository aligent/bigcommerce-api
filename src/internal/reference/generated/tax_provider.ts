...
export interface paths {
    readonly "/estimate": {
         ...
         */
        readonly post: operations["estimateTaxes"];
    };
    readonly "/void": {
        readonly parameters: {
            readonly query?: never;
         ...
         *     > - The Try it feature is not currently supported for this endpoint.
         */
        readonly post: operations["voidTaxQuote"];
    };
    readonly "/commit": {
        readonly parameters: {
            readonly query?: never;
         ...
         *     > - The Try it feature is not currently supported for this endpoint.
         */
        readonly post: operations["commitTaxQuote"];
    };
    readonly "/adjust": {
        readonly parameters: {
            readonly query?: never;
         ...
         *     > - The Try it feature is not currently supported for this endpoint.
         */
        readonly post: operations["adjustTaxQuote"];
    };
}
...
export interface components {
    schemas: {
         ...
         */
        readonly "request-item-tax-property": {
            /**
         ...
         * @enum {string}
         */
        readonly item_type: "item" | "refund" | "fee";
        /**
         * @description The type of item for the line item in the document.
         * @enum {string}
         */
        readonly shipping_type: "shipping";
        /**
         * @description The type of item for the line item in the document.
         * @enum {string}
         */
        readonly handling_type: "handling";
        /**
         * @description The type of item for the line item in the document.
         * @enum {string}
         */
        readonly wrapping_type: "wrapping";
    };
    responses: never;
    parameters: {
...
export interface operations {
    readonly estimateTaxes: {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description BigCommerce will send through the store hash as part of all tax provider operations. Each BigCommerce store on the platform has a unique store hash value for the store’s lifetime. This value can assist in account verification or profile matching responsibilities. */
                readonly "X-Bc-Store-Hash": components["parameters"]["StoreHashHeader"];
            };
            readonly path?: never;
            readonly cookie?: never;
        };
    ...
    readonly voidTaxQuote: {
        readonly parameters: {
            readonly query: {
                /** @description Unique ID identifying the existing, persisted tax quote that will be voided. */
                readonly id: components["parameters"]["IdQueryVoid"];
            };
            readonly header: {
                /** @description BigCommerce will send through the store hash as part of all tax provider operations. Each BigCommerce store on the platform has a unique store hash value for the store’s lifetime. This value can assist in account verification or profile matching responsibilities. */
                readonly "X-Bc-Store-Hash": components["parameters"]["StoreHashHeader"];
    ...
    readonly adjustTaxQuote: {
        readonly parameters: {
            readonly query: {
                /** @description Unique ID identifying the existing, persisted tax quote that will be adjusted. */
                readonly id: components["parameters"]["IdQueryAdjusted"];
            };
            readonly header: {
                /** @description BigCommerce will send through the store hash as part of all tax provider operations. Each BigCommerce store on the platform has a unique store hash value for the store’s lifetime. This value can assist in account verification or profile matching responsibilities. */
                readonly "X-Bc-Store-Hash": components["parameters"]["StoreHashHeader"];
